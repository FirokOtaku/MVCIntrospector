...
public final class CurrentControllerNames
{
	...
	/**
	 * <p>当前项目中由 MVCI 生成的所有实体类 Controller 完整限定名</p>
	 * <p>An array contains full qualified names of all controller-class generated by MVCI</p>
	 *
	...
	/**
	 * <p>从类完整限定名获取对应 Controller 的完整限定名</p>
	 * <p>To get full qualified name of controller-class by full qualified name of bean-class</p>
	 *
	 * @param fullQualifiedBeanName 类完整限定名
	 * @return Controller 完整限定名
