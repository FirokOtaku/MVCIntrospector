...
public final class CurrentServiceImplClasses
{
	private CurrentServiceImplClasses() throws InstantiationException { throw new InstantiationException("不允许初始化"); }



	/**
	 * <p>当前项目中所有由 MVCI 生成的 Service Impl 类对象</p>
	 * <p>An array contains Class instances of all service-impl-class generated by MVCI</p>
	 *
